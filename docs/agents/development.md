...
The strict-versus-pragmatic separation policy awaits the choice recorded in [the review](../agent-guidance-review.md); this document does not authorize restructuring the repository.

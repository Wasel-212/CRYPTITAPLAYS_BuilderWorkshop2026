...
- For Camera changes, read [photo output requirements](../../spec/09-photo-output-layout-capability.md). Reuse the live card data and shared faces in the off-screen export; preserve 1080x1350 output and disable export unless the portfolio loaded successfully.
